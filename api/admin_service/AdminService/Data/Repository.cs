...
namespace AdminService.Data
{
    public interface IRepository<TEntity> : IDisposable where TEntity : class
    {
        ...
        Task<(long total, IEnumerable<TEntity> entities)> FindManyAsync(FilterDefinition<TEntity> filter = default(FilterDefinition<TEntity>)!, BsonDocument? sort = null!, BsonDocument? lookup = null!, int? limit = 100, int? skip = null!);
